...
#   FLATPAK_BUNDLE=Letter-1.0.0-rc.1-x86_64.flatpak ./scripts/build-flatpak.sh
set -euo pipefail
...
bundle="${FLATPAK_BUNDLE:-Letter-$(git describe --tags --always 2>/dev/null || echo 1.0.0-rc.1)-x86_64.flatpak}"
...
echo "  - Microsoft 365 Graph mail may need evolution-ews on the host; IMAP/Google are the safer first test."
