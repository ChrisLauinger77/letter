...
#   FLATPAK_BUNDLE=Letter-1.0.0-rc.2-x86_64.flatpak ./scripts/build-flatpak.sh
set -euo pipefail
...
bundle="${FLATPAK_BUNDLE:-Letter-$(git describe --tags --always 2>/dev/null || echo 1.0.0-rc.2)-x86_64.flatpak}"
